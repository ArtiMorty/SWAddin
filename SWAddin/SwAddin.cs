...
{
    /// <summary>
    /// Summary description for SWAddin.
    /// </summary>
    [Guid("7d18655f-1dec-4d7f-837f-7f6df0b461af"), ComVisible(true)]
    [SwAddin(
        Description = "SWAddin description",
        Title = "SWAddin",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("SWAddin.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("SWAddin.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("SWAddin.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("SWAddin.MainIconSmall.bmp", thisAssembly);
